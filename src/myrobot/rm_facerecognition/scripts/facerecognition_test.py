...
'''
ho compilato cv_bridge con:
catkin_make 
 -DCATKIN_WHITELIST_PACKAGES="cv_bridge" 
...
class myFaceRecognition():
    ...
    def __init__(self, node_name):
        ...
        #self.image_sub = rospy.Subscriber("/usb_cam/image_raw", CompressedImage, self.image_callback, queue_size=1)
