...
# mie annotazioni-------------------------------------------
# derivata da  client3 ma con integrato snowboy detection
...
# dialogflow
import dialogflow_v2 as dialogflow_v2beta1
from dialogflow_v2beta1.types \
...
class MyDialogflowClient(object):
    def __init__(self, language_code='it-IT', last_contexts=None):
        ...
        self.bat_watt = 0
        rospy.Subscriber('/bat_watt', Float64, self.cbk_bat_watt)
    ...
    def cbk_bat_charge(self, msg):
        ...
        #print("\nBattery cbk:{}".format(self.bat_charge))
    ...
    def cbk_bat_ampere(self, msg):
        ...
        #print("\nBattery cbk:{}".format(self.bat_charge))
    def cbk_bat_watt(self, msg):
        self.bat_watt = msg.data
        #print("\nBattery cbk:{}".format(self.bat_charge))
