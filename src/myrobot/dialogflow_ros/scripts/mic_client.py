...
"""
Funziona ma non devi superare 253 secondi di silenzio perchè ritorna 
exceeded time limit
"""
    ...
    def _listen_print_loop(self, responses):
        ...
        try:
            for response in responses:
                ...
                transcript = result.alternatives[0].transcript  #formato unicode 
                ...
                if result.is_final:
                    ...
                    #self.text_pub.publish(transcript_unicode.decode('latin_1'))  #
    ...
    def start_client(self):
        ...
        try:
            while True:            
                ...
                self.gspeech_client()
                rospy.loginfo("---uscito dal loop. mi riconnetto----")
